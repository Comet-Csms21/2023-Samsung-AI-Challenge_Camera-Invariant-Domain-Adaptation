...
def drn_a_50(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load('./modeling/backbone/pretrained/resnet50.pth'))
        print("Load Success")
    return model
...
def drn_c_26(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_c_26.pth')
        print("Load Success1")
...
def drn_c_42(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_c_42.pth')
        print("Load Success2")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
def drn_c_58(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_c_58.pth')
        print("Load Success3")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
def drn_d_22(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_d_22.pth')
        print("Load Success4")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
"""def drn_d_24(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./pretrained/drn_d_24.pth')
        print("Load Success")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
def drn_d_38(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_d_38.pth')
        print("Load Success5")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
"""def drn_d_40(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./pretrained/drn_d_40.pth')
        print("Load Success")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
def drn_d_54(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_d_54.pth')
        print("Load Success6")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
...
def drn_d_105(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        pretrained = torch.load('./modeling/backbone/pretrained/drn_d_105.pth')
        print("Load Success7")
        del pretrained['fc.weight']
        del pretrained['fc.bias']
        model.load_state_dict(pretrained)
